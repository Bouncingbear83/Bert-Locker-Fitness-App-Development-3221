...
export default function Login() {
  ...
  const features = [
    { icon: Dumbbell, title: 'Track Workouts', description: 'Log your sets, reps, and weights' },
    { icon: Sparkles, title: 'Smart Templates', description: 'Create custom workout routines' },
    { icon: Shield, title: 'Progress Analytics', description: 'Monitor your fitness journey' },
  ];
